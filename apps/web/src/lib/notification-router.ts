...
export async function routeNotification(request:NotificationRequest){
  ...
  const result:any={correlationId,notificationType:request.notificationType,urgency:policy.urgency,plan:{pushAllowed,emailAllowed,smsAllowed,smsImmediate:policy.smsImmediate,smsFallback:policy.smsFallback,emailAlways:Boolean(policy.emailAlways)},push:{attempted:0,accepted:0,failed:0},email:{attempted:false,accepted:false,skipped:false},messaging:{attempted:false,accepted:false}};
