...
export default function SupportPage(){
  ...
  return <main style={{maxWidth:760,margin:"40px auto",padding:"0 20px",fontFamily:"system-ui,sans-serif"}}>
    <section style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(230px,1fr))",gap:12,marginBottom:20}}>
      <a href="/help" style={{padding:18,border:"1px solid #cbd5e1",borderRadius:16,textDecoration:"none",color:"#101b33",background:"#fff"}}><strong>Need help?</strong><div style={{color:"#64748b",marginTop:5}}>Open the BandWagon Help Center</div></a>
      <a href={statusUrl} target="_blank" rel="noreferrer" style={{padding:18,border:"1px solid #cbd5e1",borderRadius:16,textDecoration:"none",color:"#101b33",background:"#fff"}}><strong>Is BandWagon online?</strong><div style={{color:"#64748b",marginTop:5}}>Check Platform Status</div></a>
    </section>
